...
<div class="w3-content w3-padding" style="max-width:1564px">
  ...
  <div class="container w3-padding-32" id="about">
    ...
    <div class="w3-content" style="max-width:700px">
	    <p style="text-align:justify;">Divyafashins is an Fashion Educational Institute.Established in 2001,and Institute offers world class quality of education and wide range of courses.Divyafashins Institute has a dedicated placement team to help students get job placement in various Fashion Designer roles with major companies.
	    </p>
		...
		<p><strong>E-Mail ID :</strong>  divyafashins@gmail.com</p>
  	</div>
   </div>
...
<footer class="w3-center  w3-padding-16" style="background-color:#1C3B47 ">
  <p style="color:#FFFFFF ">Copyright @2017 <a href="#"  target="_blank" class="w3-hover-text-green"> divyafashins.com</a></p>
</footer>
